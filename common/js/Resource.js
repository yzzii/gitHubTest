...
$("#popOpenBtn").click(function(event){  //팝업 Open 버튼 클릭 시  
  $("#popWarp").css({
    "top": (($(window).height()-$("#popWarp").outerHeight())/2+$(window).scrollTop())+"px",
    "left": (($(window).width()-$("#popWarp").outerWidth())/2+$(window).scrollLeft())+"px"
    //팝업창을 가운데로 띄우기 위해 현재 화면의 가운데 값과 스크롤 값을 계산하여 팝업창 CSS 설정  
  }); 

  $("#popup_mask").css("display","block"); //팝업 뒷배경 display block
  $("#popWarp").css("display","block"); //팝업창 display block 
